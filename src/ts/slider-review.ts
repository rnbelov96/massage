...
const imagesBoxEl = document.querySelector(
  '.slider-review__img-box',
) as HTMLDivElement;
const wrapperEl = document.querySelector('.slider-review__wrapper') as HTMLDivElement;
...
const navBoxEl = document.querySelector('.slider-review__nav-box') as HTMLDivElement;

const prevBtnEl = document.querySelector('.slider-review__btn-prev') as HTMLButtonElement;
const nextBtnEl = document.querySelector('.slider-review__btn-next') as HTMLButtonElement;
...
navItemList = Array(imagesLength)
  ...
  .map((_el, index) => {
    ...
    navItemEl.classList.add('slider-review__nav-item');
    if (index === 0) {
      navItemEl.classList.add('slider-review__nav-item_active');
    }
    ...
    navItemEl.addEventListener('click', e => {
      ...
      navItemList[currentImage - 1].classList.add('slider-review__nav-item_active');
      navItemList[prevCurrentImage - 1].classList.remove(
        'slider-review__nav-item_active',
      );
      setTimeout(() => {
